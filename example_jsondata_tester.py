# This file searches for articles but uses a sample data dictionary so requests method is not used. Its used
# when you run out of the free articles that you can access in a 24 hour window.
